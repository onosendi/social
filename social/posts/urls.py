...
urlpatterns = [
    ...
    path(
        '<int:pk>/likes/',
        views.LikesAPIView.as_view(),
        name='likes'),
    path('<int:pk>/replies/',
         views.PostRepliesAPIView.as_view(),
         name='replies'),
    path('feed/',
         views.FeedAPIView.as_view(),
         name='feed'),
    path('profile/<str:slug>/likes/',
         views.ProfileLikesAPIView.as_view(),
         name='profile_likes'),
    path('profile/<str:slug>/posts/',
         views.ProfilePostsAPIView.as_view(),
         name='profile_posts'),
    path('long-recommended-posts/',
