...
urlpatterns = [
    ...
    path('auth/register/',
         ...
         name='register'),
    path('edit-password/',
         views.EditPasswordAPIView.as_view(),
         name='edit_password'),
    path('edit-profile/',
         views.EditProfileAPIView.as_view(),
         name='edit_profile'),
    path('edit-user/',
         views.EditUserAPIView.as_view(),
         name='edit_user'),
    path('long-recommended-users/',
    ...
    path('<str:slug>/',
         ...
         name='user_detail'),
    path('<str:slug>/following/',
         views.FollowingAPIView.as_view(),
         name='following'),
    path('<str:slug>/followers/',
